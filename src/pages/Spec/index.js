...
export default class Spec extends React.Component {
  ...
  componentDidMount() {
    this.props.dispatch({ type: 'specManagement/handleSpec' });
    ...
    let authHeader = "hmac username=\"" + username + "\", algorithm=\"" + algorithmForKong + "\", headers=\"x-date\", signature=\"" + signature + "\"";

    fetch('http://47.115.8.86:8000/api/keyauthtest?key=SD_-K6P83opRTQhOq&location=beijing&language=zh-Hans&unit=c',
      {
        headers: {
          'x-date': dateString,
